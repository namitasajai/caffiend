      ...
      <Tab.Navigator
        screenOptions={({ route }) => ({
          tabBarIcon: ({ focused, color, size }) => {
            const iconProps = { size, color, weight: focused ? 'fill' : 'thin' };
            switch (route.name) {
              case 'Home': return <House {...iconProps} />;
              case 'Social': return <UsersThree {...iconProps} />;
              case 'Favorites': return <Heart {...iconProps} />;
              case 'Review': return <Clipboard {...iconProps} />;
              default: return null;
            }
          },
